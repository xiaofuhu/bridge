...
HD_PWD='C:/Users/fuhu/Desktop/bridge/bridge.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bridge_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bridge_top.tcl
