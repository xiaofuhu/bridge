...
HD_PWD='C:/Users/fuhu/Desktop/bridge/bridge.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bridge_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bridge_top.tcl -notrace
